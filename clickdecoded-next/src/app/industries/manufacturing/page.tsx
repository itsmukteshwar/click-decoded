/* eslint-disable */
// src/app/industries/manufacturing/page.tsx — generated from industry-manufacturing.html (do not edit header/footer here)
import type { Metadata } from 'next'
import PageScript from '@/components/chrome/PageScript'

export const metadata: Metadata = {
  title: "Digital Marketing for Manufacturers & Industrial B2B India",
  description: "B2B lead generation, SEO, and web development for manufacturers, industrial companies, and exporters in India. Click Decoded drives dealer and enterprise.",
  alternates: { canonical: "/industries/manufacturing" },
}

const css = `
:root{--n:#2A4573;--n2:#1e3460;--n-dark:#0f1e38;--o:#EE7E1A;--o2:#d46e12;--body:#1E293B;--m:#475569;--s:#64748b;--bg:#F4F7FC;--bdr:#E2E8F0;--gr:#25D366;--ac:#607D8B;--ac-rgb:96,125,139;}
...
.hero::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 55% 60% at 70% 30%,rgba(96,125,139,.18) 0%,transparent 65%),radial-gradient(ellipse 35% 40% at 5% 80%,rgba(96,125,139,.07) 0%,transparent 60%);pointer-events:none;}
.hero-grid{display:grid;grid-template-columns:1fr 1fr;gap:60px;align-items:center;position:relative;z-index:2;}
.hero-eyebrow{display:inline-flex;align-items:center;gap:8px;padding:6px 16px;background:rgba(96,125,139,.12);border:1px solid rgba(96,125,139,.3);border-radius:99px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.12em;color:#b0bec5;margin-bottom:20px;}
...
.hero h1 em{font-style:normal;background:linear-gradient(135deg,#b0bec5,#607D8B);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;}
.hero-desc{font-size:17px;color:rgba(255,255,255,.62);line-height:1.7;margin-bottom:32px;max-width:460px;}
.hero-btns{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:36px;}
/* MANUFACTURING DASHBOARD MOCK */
.mfg-mock{background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:20px;overflow:hidden;backdrop-filter:blur(10px);}
.mfg-mock-header{background:rgba(255,255,255,.05);border-bottom:1px solid rgba(255,255,255,.08);padding:14px 18px;display:flex;align-items:center;justify-content:space-between;}
.mfg-mock-title{font-size:12px;font-weight:700;color:rgba(255,255,255,.7);letter-spacing:.04em;}
.mfg-live{display:flex;align-items:center;gap:6px;font-size:11px;color:#607D8B;font-weight:600;}
.mfg-live::before{content:'';width:7px;height:7px;border-radius:50%;background:#607D8B;box-shadow:0 0 0 3px rgba(96,125,139,.2);animation:mfgpulse 2s infinite;}
@keyframes mfgpulse{0%,100%{box-shadow:0 0 0 3px rgba(96,125,139,.2);}50%{box-shadow:0 0 0 6px rgba(96,125,139,.05);}}
.mfg-kpis{display:grid;grid-template-columns:1fr 1fr;gap:1px;background:rgba(255,255,255,.06);}
.mfg-kpi{background:#0f1e38;padding:16px 18px;}
.mfg-kpi-label{font-size:10.5px;font-weight:600;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.08em;margin-bottom:6px;}
.mfg-kpi-val{font-size:22px;font-weight:900;color:#fff;letter-spacing:-.02em;line-height:1;}
.mfg-kpi-val.steel{color:#607D8B;}
.mfg-kpi-delta{font-size:11px;margin-top:4px;font-weight:600;}
.mfg-kpi-delta.up{color:#4caf50;}
.mfg-leads{padding:16px 18px;border-top:1px solid rgba(255,255,255,.06);}
.mfg-leads-label{font-size:10.5px;font-weight:600;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.08em;margin-bottom:10px;}
.mfg-lead-row{display:flex;align-items:center;justify-content:space-between;padding:6px 0;border-bottom:1px solid rgba(255,255,255,.05);}
.mfg-lead-row:last-child{border-bottom:none;}
.mfg-lead-name{font-size:12px;color:rgba(255,255,255,.6);}
.mfg-lead-tag{font-size:10px;font-weight:700;padding:2px 8px;border-radius:99px;background:rgba(96,125,139,.15);color:#b0bec5;}
.mfg-wa{padding:14px 18px;background:rgba(96,125,139,.06);border-top:1px solid rgba(96,125,139,.1);display:flex;align-items:center;justify-content:space-between;}
.mfg-wa-label{font-size:12px;color:rgba(255,255,255,.5);font-weight:500;}
.mfg-wa-val{font-size:16px;font-weight:800;color:#607D8B;}
...
@media(max-width:960px){.hero-grid{grid-template-columns:1fr;}.mfg-mock{display:none;}.pain-grid,.why-grid{grid-template-columns:repeat(2,1fr);}.faq-grid{grid-template-columns:1fr;}.fg{grid-template-columns:1fr 1fr;}}
...
.hero-btns{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:36px;}
.mfg-mock{background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:20px;overflow:hidden;backdrop-filter:blur(10px);}
.mfg-hdr{background:rgba(255,255,255,.05);border-bottom:1px solid rgba(255,255,255,.08);padding:14px 18px;display:flex;align-items:center;justify-content:space-between;}
.mfg-hdr-title{font-size:12px;font-weight:700;color:rgba(255,255,255,.7);letter-spacing:.04em;}
.mfg-live{display:flex;align-items:center;gap:6px;font-size:11px;color:#607D8B;font-weight:600;}
.mfg-live::before{content:'';width:7px;height:7px;border-radius:50%;background:#607D8B;box-shadow:0 0 0 3px rgba(96,125,139,.2);animation:mfgp 2s infinite;}
@keyframes mfgp{0%,100%{box-shadow:0 0 0 3px rgba(96,125,139,.2);}50%{box-shadow:0 0 0 6px rgba(96,125,139,.05);}}
.mfg-kpis{display:grid;grid-template-columns:1fr 1fr;gap:1px;background:rgba(255,255,255,.06);}
.mfg-kpi{background:#0f1e38;padding:14px 16px;}
.mfg-kpi-lbl{font-size:10px;font-weight:600;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.08em;margin-bottom:5px;}
.mfg-kpi-val{font-size:20px;font-weight:900;color:#607D8B;letter-spacing:-.02em;line-height:1;}
.mfg-kpi-d{font-size:10.5px;margin-top:3px;font-weight:600;color:#4caf50;}
.mfg-rows{padding:14px 18px;border-top:1px solid rgba(255,255,255,.06);}
.mfg-rows-lbl{font-size:10px;font-weight:600;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px;}
.mfg-row{display:flex;justify-content:space-between;align-items:center;padding:5px 0;border-bottom:1px solid rgba(255,255,255,.04);font-size:11.5px;}
.mfg-row:last-child{border:none;}
.mfg-row-n{color:rgba(255,255,255,.55);}
.mfg-row-v{color:#b0bec5;font-weight:700;font-size:11px;}
.mfg-btm{padding:12px 18px;background:rgba(96,125,139,.06);border-top:1px solid rgba(96,125,139,.1);display:flex;align-items:center;justify-content:space-between;}
.mfg-btm-lbl{font-size:11.5px;color:rgba(255,255,255,.45);}
.mfg-btm-val{font-size:15px;font-weight:800;color:#607D8B;}
@media(max-width:900px){.hero-grid{grid-template-columns:1fr;}.mfg-mock{display:none;}}
  ...
  "@graph": [
    {
      ...
      "description": "B2B lead generation, SEO, and web development for manufacturers, industrial companies, and exporters in India. Click Decoded drives dealer and enterprise buyer enquiries.",
      "areaServed": {
        "@type": "Country",
        "name": "India"
      },
      "serviceType": "Digital Marketing for Manufacturing",
      "url": "https://www.clickdecoded.com/industries/manufacturing"
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Digital Marketing for Manufacturing",
          "item": "https://www.clickdecoded.com/industries/manufacturing"
        }
      ]
    }
  ]
...
<div>
<div className="hero-eyebrow">🏭 Manufacturing &amp; Industrial B2B Marketing</div>
<h1>More B2B Leads<br /><em>for Manufacturers &amp; Industrial Companies.</em></h1>
<p className="hero-desc">Industrial buyers research online before they contact a vendor. We build SEO, Google Ads, and professional websites that put your factory in front of procurement teams.</p>
...
<span className="proof-item"><strong>218%</strong> More Inbound Enquiries</span>
<span className="proof-item"><strong>Export</strong> Buyer Inquiries Generated</span>
<span className="proof-item"><strong>B2B</strong> Decision-Maker Targeting</span>
</div>
</div>
<div className="mfg-mock">
<div className="mfg-hdr">
<span className="mfg-hdr-title">B2B Lead Pipeline Dashboard</span>
<span className="mfg-live">Live</span>
</div>
<div className="mfg-kpis">
<div className="mfg-kpi"><div className="mfg-kpi-lbl">Inbound Enquiries</div><div className="mfg-kpi-val">142</div><div className="mfg-kpi-d">↑ 218% in 6 months</div></div>
<div className="mfg-kpi"><div className="mfg-kpi-lbl">RFQ Conversions</div><div className="mfg-kpi-val">28</div><div className="mfg-kpi-d">↑ high-value deals</div></div>
<div className="mfg-kpi"><div className="mfg-kpi-lbl">Google Rank</div><div className="mfg-kpi-val">#1</div><div className="mfg-kpi-d">↑ target keywords</div></div>
<div className="mfg-kpi"><div className="mfg-kpi-lbl">Export Inquiries</div><div className="mfg-kpi-val">19</div><div className="mfg-kpi-d">↑ international buyers</div></div>
</div>
<div className="mfg-rows">
<div className="mfg-rows-lbl">Recent High-Value RFQs</div>
<div className="mfg-row"><span className="mfg-row-n">Tata Motors — Component Supply</span><span className="mfg-row-v">₹42L order</span></div>
<div className="mfg-row"><span className="mfg-row-n">UAE Bulk Order — Export</span><span className="mfg-row-v">₹28L inquiry</span></div>
<div className="mfg-row"><span className="mfg-row-n">OEM Partnership — Auto</span><span className="mfg-row-v">₹18L/quarter</span></div>
</div>
<div className="mfg-btm">
<span className="mfg-btm-lbl">🏭 Pipeline Value This Quarter</span>
<span className="mfg-btm-val">₹2.4Cr+</span>
</div>
</div>
</div>
</div>
...
<div className="res-stat"><div className="res-num">5x</div><div className="res-lbl">More B2B Enquiries</div></div><div className="res-stat"><div className="res-num">Top 3</div><div className="res-lbl">Google Rankings</div></div><div className="res-stat"><div className="res-num">Export</div><div className="res-lbl">Market Reach</div></div><div className="res-stat"><div className="res-num">₹25K</div><div className="res-lbl">Starting / Month</div></div>
</div>
</div>
...
<div className="pain-card"><div className="pain-icon">🌐</div><h3>Outdated or Non-Existent Website</h3><p>Industrial buyers judge supplier credibility by their website. An outdated site with no certifications, product specs, or contact form loses you enterprise deals before you even know about them.</p></div><div className="pain-card"><div className="pain-icon">🔍</div><h3>Zero Online Visibility</h3><p>Buyers search 'HDPE pipe manufacturer India' or 'stainless steel fabricator Pune' on Google. If you're not ranking, you're not even in the consideration set.</p></div><div className="pain-card"><div className="pain-icon">📋</div><h3>No Digital Catalogue</h3><p>A downloadable product catalogue, specification sheets, and brochure PDFs on your website give buyers what they need to shortlist you — and most manufacturers don't have this online.</p></div><div className="pain-card"><div className="pain-icon">🌏</div><h3>Missed Export Opportunities</h3><p>International buyers find Indian manufacturers primarily through Google and B2B platforms. A well-optimised website and IndiaMART/Alibaba presence opens export enquiries passively.</p></div><div className="pain-card"><div className="pain-icon">🤝</div><h3>No Dealer/Distributor Acquisition Strategy</h3><p>Expanding your dealer network requires targeted outreach. We build dealer recruitment landing pages and LinkedIn campaigns that attract qualified distributors.</p></div><div className="pain-card"><div className="pain-icon">📊</div><h3>No Lead Tracking</h3><p>Most manufacturing companies don't know which enquiries came from the website, which from Google, and which from referral. We build proper attribution so you know what's working.</p></div>
</div>
</div>
</section>
...
<div className="svc-pill"><a href="/services/seo">🔍 SEO Services</a></div><div className="svc-pill"><a href="/services/web-development">💻 Web Development</a></div><div className="svc-pill"><a href="/services/google-ads">💰 Google Ads</a></div><div className="svc-pill"><a href="/services/linkedin-ads">💼 LinkedIn Ads</a></div><div className="svc-pill"><a href="/services/programmatic-seo">⚙️ Programmatic SEO</a></div><div className="svc-pill"><a href="/services/blogging">✍️ Blogging &amp; Content</a></div><div className="svc-pill"><a href="/services/product-photography">📸 Product Photography</a></div><div className="svc-pill"><a href="/services/ai-automation">🤖 AI Automation</a></div><div className="svc-pill"><a href="/services/landing-pages">📋 Landing Pages</a></div><div className="svc-pill"><a href="/services/email-marketing">✉️ Email Marketing</a></div>
</div>
</div>
</section>
...
<div className="faq-item"><button className="faq-q">Do you have experience with industrial/technical products?<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M4 6l4 4 4-4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg></button><div className="faq-a"><p>Yes. We've created content and campaigns for steel fabricators, plastic manufacturers, chemical companies, packaging firms, and engineering product manufacturers. We research your product before writing anything.</p></div></div><div className="faq-item"><button className="faq-q">Can you help with B2B export marketing?<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M4 6l4 4 4-4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg></button><div className="faq-a"><p>Yes — SEO targeting international buyer keywords, Google Ads for 'supplier' and 'manufacturer' searches, and IndiaMART/Alibaba profile optimisation.</p></div></div><div className="faq-item"><button className="faq-q">Do you create product catalogues and technical content?<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M4 6l4 4 4-4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg></button><div className="faq-a"><p>Yes. Product catalogue PDFs, technical spec pages, and case study content are available as part of our content marketing packages.</p></div></div><div className="faq-item"><button className="faq-q">Can you build a B2B e-commerce/order portal?<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M4 6l4 4 4-4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg></button><div className="faq-a"><p>Yes. Trade portals with inquiry forms, quote request systems, dealer logins, and product configurators are available as custom development projects.</p></div></div><div className="faq-item"><button className="faq-q">How do you generate dealer/distributor enquiries?<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M4 6l4 4 4-4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg></button><div className="faq-a"><p>Dedicated dealer acquisition landing pages + Google Ads targeting 'distributors wanted' keywords + LinkedIn outreach to relevant channel partners in target regions.</p></div></div><div className="faq-item"><button className="faq-q">What's the starting engagement?<svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M4 6l4 4 4-4" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" /></svg></button><div className="faq-a"><p>Manufacturing digital marketing starts at ₹25,000/month for SEO or website development. Multi-channel B2B lead generation campaigns are quoted based on target markets.</p></div></div>
</div>
</div>
</section>
...
<a href="/services/seo" className="rel-pill">SEO Services</a><a href="/services/web-development" className="rel-pill">Web Development</a><a href="/services/linkedin-ads" className="rel-pill">LinkedIn Ads</a><a href="/services/google-ads" className="rel-pill">Google Ads</a>
</div>
</div>
...
<a href="https://wa.me/919407000101" className="btn btn-wa">💬 WhatsApp Now</a>
      ...
      <PageScript id="industries-manufacturing-0" code={js0} />
    </>
  )
}
