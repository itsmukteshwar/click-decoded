/* eslint-disable */
// src/app/locations/indore/meta-ads/page.tsx — generated from meta-ads-indore.html (do not edit header/footer here)
import type { Metadata } from 'next'
import PageScript from '@/components/chrome/PageScript'

export const metadata: Metadata = {
  title: "Meta Ads Agency in Indore | Facebook & Instagram Ads",
  description: "Expert Meta Ads (Facebook & Instagram) management for Indore businesses. Lead gen, brand awareness & retargeting campaigns. Free audit. Call +91 94070 00101.",
  alternates: { canonical: "/locations/indore/meta-ads" },
  openGraph: {
    title: "Meta Ads Agency in Indore — Click Decoded",
    description: "Facebook & Instagram Ads for Indore businesses. Lead generation specialists. Free audit.",
    url: "/locations/indore/meta-ads",
    type: "website",
  },
}
...
.mai-mock{background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:20px;overflow:hidden;backdrop-filter:blur(10px);}
.mai-hdr{background:rgba(255,255,255,.05);border-bottom:1px solid rgba(255,255,255,.08);padding:14px 18px;display:flex;align-items:center;justify-content:space-between;}
.mai-hdr-title{font-size:12px;font-weight:700;color:rgba(255,255,255,.7);letter-spacing:.04em;}
.mai-live{display:flex;align-items:center;gap:6px;font-size:11px;color:#6366F1;font-weight:600;}
.mai-live::before{content:'';width:7px;height:7px;border-radius:50%;background:#6366F1;box-shadow:0 0 0 3px rgba(99,102,241,.2);animation:maip 2s infinite;}
@keyframes maip{0%,100%{box-shadow:0 0 0 3px rgba(99,102,241,.2);}50%{box-shadow:0 0 0 6px rgba(99,102,241,.05);}}
.mai-kpis{display:grid;grid-template-columns:1fr 1fr;gap:1px;background:rgba(255,255,255,.06);}
.mai-kpi{background:#0f1e38;padding:14px 16px;}
.mai-kpi-lbl{font-size:10px;font-weight:600;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.08em;margin-bottom:5px;}
.mai-kpi-val{font-size:20px;font-weight:900;color:#6366F1;letter-spacing:-.02em;line-height:1;}
.mai-kpi-d{font-size:10.5px;margin-top:3px;font-weight:600;color:#4caf50;}
.mai-rows{padding:14px 18px;border-top:1px solid rgba(255,255,255,.06);}
.mai-rows-lbl{font-size:10px;font-weight:600;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px;}
.mai-row{display:flex;justify-content:space-between;align-items:center;padding:5px 0;border-bottom:1px solid rgba(255,255,255,.04);font-size:11.5px;}
.mai-row:last-child{border:none;}
.mai-row-n{color:rgba(255,255,255,.55);}
.mai-row-v{color:#a5b4fc;font-weight:700;font-size:11px;}
.mai-btm{padding:12px 18px;background:rgba(99,102,241,.06);border-top:1px solid rgba(99,102,241,.1);display:flex;align-items:center;justify-content:space-between;}
.mai-btm-lbl{font-size:11.5px;color:rgba(255,255,255,.45);}
.mai-btm-val{font-size:15px;font-weight:800;color:#6366F1;}
@media(max-width:900px){.hero-grid{grid-template-columns:1fr;}.mai-mock{display:none;}}
`
  ...
  "@graph": [
    {
      ...
      "serviceType": "Meta (Facebook & Instagram) Ads",
      "url": "https://www.clickdecoded.com/locations/indore/meta-ads"
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Meta (Facebook & Instagram) Ads",
          "item": "https://www.clickdecoded.com/locations/indore/meta-ads"
        }
      ]
    }
  ]
...
<li>›</li>
<li>Meta Ads Agency in Indore</li>
</ol>
</div>
</nav>
...
<div>
<div className="hero-eyebrow">📘 Meta Ads — Indore, MP</div>
<h1>Facebook &amp; Instagram Ads<br /><em>That Generate Indore Leads Daily.</em></h1>
<p className="hero-desc">Indore's buyers are on Facebook and Instagram every day. We build Meta Ads campaigns that put your business in front of the right audience — and convert them into paying customers.</p>
...
<span className="proof-item"><strong>4.5×</strong> Average ROAS</span>
<span className="proof-item"><strong>₹16</strong> Avg. Cost Per Lead</span>
<span className="proof-item"><strong>Indore-Targeted</strong> Audience Segments</span>
</div>
</div>
<div className="mai-mock">
<div className="mai-hdr">
<span className="mai-hdr-title">Meta Ads Dashboard — Indore</span>
<span className="mai-live">Live</span>
</div>
<div className="mai-kpis">
<div className="mai-kpi"><div className="mai-kpi-lbl">Monthly Leads</div><div className="mai-kpi-val">542</div><div className="mai-kpi-d">↑ 380% vs previous</div></div>
<div className="mai-kpi"><div className="mai-kpi-lbl">Cost Per Lead</div><div className="mai-kpi-val">₹16</div><div className="mai-kpi-d">↓ 77% from ₹71</div></div>
<div className="mai-kpi"><div className="mai-kpi-lbl">ROAS</div><div className="mai-kpi-val">4.5×</div><div className="mai-kpi-d">↑ from 0.8× at start</div></div>
<div className="mai-kpi"><div className="mai-kpi-lbl">Reach</div><div className="mai-kpi-val">2.4L/mo</div><div className="mai-kpi-d">↑ Indore-targeted</div></div>
</div>
<div className="mai-rows">
<div className="mai-rows-lbl">Top Performing Ad Creatives</div>
<div className="mai-row"><span className="mai-row-n">Real Estate Offer Reel</span><span className="mai-row-v">₹12 CPL · 7.4% CTR</span></div>
<div className="mai-row"><span className="mai-row-n">Education Testimonial Carousel</span><span className="mai-row-v">₹19 CPL · 5.8% CTR</span></div>
<div className="mai-row"><span className="mai-row-n">Clinic Before/After</span><span className="mai-row-v">₹21 CPL · 4.9% CTR</span></div>
</div>
<div className="mai-btm">
<span className="mai-btm-lbl">🎯 Total Indore Audience Reached</span>
<span className="mai-btm-val">18L+ this year</span>
</div>
</div>
</div>
</div>
...
<div><div className="res-num">4<em>x</em></div><div className="res-label">Average Lead ROAS</div></div>
<div><div className="res-num">30<em>%</em></div><div className="res-label">Lower CPL vs. Avg</div></div>
<div><div className="res-num">500<em>+</em></div><div className="res-label">Campaigns Managed</div></div>
<div><div className="res-num">24<em>hr</em></div><div className="res-label">Go-Live Time</div></div>
</div>
</div>
</div>
...
<h2>Complete Meta Ads Management for Indore Businesses</h2>
<p>Everything included — no half-measures, no hidden extras.</p>
</div>
<div className="inc-grid">
<div className="inc-card">
<div className="inc-icon">🎯</div>
<div className="inc-title">Lead Generation Campaigns</div>
<div className="inc-desc">Capture Indore leads directly in Facebook — no website visit needed.</div>
<ul className="inc-list"> <li>Lead form ad setup</li>
<li>Audience targeting</li>
<li>Creative strategy</li>
<li>A/B test creatives</li>
<li>CRM integration</li></ul>
</div>
<div className="inc-card">
<div className="inc-icon">🖼️</div>
<div className="inc-title">Creative Strategy &amp; Design</div>
<div className="inc-desc">Great ads start with great creative. We write copy and design visuals that stop the scroll.</div>
<ul className="inc-list"> <li>Ad copy writing</li>
<li>Static image ads</li>
<li>Video ad scripts</li>
<li>Carousel ads</li>
<li>Story ads</li></ul>
</div>
<div className="inc-card">
<div className="inc-icon">👥</div>
<div className="inc-title">Audience Building</div>
<div className="inc-desc">Reach the exact Indore audience most likely to buy from you.</div>
<ul className="inc-list"> <li>Custom audience creation</li>
<li>Lookalike audiences</li>
<li>Interest &amp; behavior targeting</li>
<li>Location-based targeting</li>
<li>Retargeting setup</li></ul>
</div>
<div className="inc-card">
<div className="inc-icon">🔄</div>
<div className="inc-title">Retargeting Campaigns</div>
<div className="inc-desc">Re-engage Indore visitors who showed interest but didn't convert yet.</div>
<ul className="inc-list"> <li>Website visitor retargeting</li>
<li>Video view retargeting</li>
<li>Lead form openers</li>
<li>Catalogue retargeting</li>
<li>Dynamic product ads</li></ul>
</div>
<div className="inc-card">
<div className="inc-icon">📊</div>
<div className="inc-title">Pixel &amp; Conversion Tracking</div>
<div className="inc-desc">Accurate tracking is the foundation of profitable Meta campaigns.</div>
<ul className="inc-list"> <li>Meta Pixel setup</li>
<li>Conversion event tracking</li>
<li>API Conversions (server-side)</li>
<li>GA4 integration</li>
<li>Attribution configuration</li></ul>
</div>
<div className="inc-card">
<div className="inc-icon">📋</div>
<div className="inc-title">Monthly Meta Reports</div>
<div className="inc-desc">Full transparency on your spend, reach, CPL, and lead quality.</div>
<ul className="inc-list"> <li>Spend &amp; CPL report</li>
...
<div className="pt-content"><div className="pt-title">Account Audit</div><div className="pt-desc">We audit your existing Meta Ads account or assess your market opportunity from scratch.</div></div>
</div>
<div className="pt-item">
<div className="pt-num">02</div>
<div className="pt-content"><div className="pt-title">Audience &amp; Creative Strategy</div><div className="pt-desc">We build your audience targeting plan and creative strategy based on Indore market insights.</div></div>
</div>
<div className="pt-item">
<div className="pt-num">03</div>
<div className="pt-content"><div className="pt-title">Campaign Launch</div><div className="pt-desc">Pixel setup, creative production, campaign build, and launch — within 24 hours.</div></div>
</div>
<div className="pt-item">
<div className="pt-num">04</div>
<div className="pt-content"><div className="pt-title">Optimization</div><div className="pt-desc">Weekly creative testing, audience refinement, and bid adjustments to lower CPL.</div></div>
</div>
<div className="pt-item">
<div className="pt-num">05</div>
<div className="pt-content"><div className="pt-title">Monthly Reports</div><div className="pt-desc">Spend, leads, CPL, and creative performance — all reported transparently.</div></div>
</div>
</div>
</div>
</section>
...
<div className="wrap">
<div className="sec-h">
<div className="eyebrow">❓ FAQs — Meta Ads Management Indore</div>
<h2>Common Questions</h2>
</div>
<div className="faq-list">
<div className="faq-item">
<button className="faq-q">How much should I spend on Meta Ads in Indore? <span className="faq-chevron">+</span></button>
<div className="faq-a"><div className="faq-a-inner">We recommend a minimum of ₹10,000–₹20,000/month in ad spend for meaningful Indore lead volume. Our management fee starts at ₹25,000/month.</div></div>
</div>
<div className="faq-item">
<button className="faq-q">How quickly do Meta Ads generate leads in Indore? <span className="faq-chevron">+</span></button>
<div className="faq-a"><div className="faq-a-inner">Lead form campaigns can generate leads within hours of launch. The first 1–2 weeks are used to optimize creative and audiences for the best CPL.</div></div>
</div>
<div className="faq-item">
<button className="faq-q">What type of businesses benefit most from Meta Ads in Indore? <span className="faq-chevron">+</span></button>
<div className="faq-a"><div className="faq-a-inner">Real estate, coaching institutes, healthcare, education, salons, fitness, restaurants, and any business with a local Indore audience respond very well to Meta Ads.</div></div>
</div>
<div className="faq-item">
<button className="faq-q">Do you create the ad creative (images/videos) for Meta campaigns? <span className="faq-chevron">+</span></button>
<div className="faq-a"><div className="faq-a-inner">Yes — we write the ad copy and design static creatives. For video ads, we can script and direct using your footage, or source stock visuals.</div></div>
</div>
<div className="faq-item">
<button className="faq-q">How do you track leads from Meta Ads in Indore? <span className="faq-chevron">+</span></button>
<div className="faq-a"><div className="faq-a-inner">We set up Meta Pixel, Conversion API (server-side tracking), and integrate with your CRM so every lead is tracked accurately — even with iOS privacy changes.</div></div>
</div>
<div className="faq-item">
<button className="faq-q">Can Meta Ads work alongside Google Ads for my Indore business? <span className="faq-chevron">+</span></button>
<div className="faq-a"><div className="faq-a-inner">Yes. Meta Ads and Google Ads serve different buyer stages — Google captures intent (people searching), Meta builds demand (reaching people who haven't searched yet). Together they maximize reach and conversions.</div></div>
</div>
</div>
</div>
</section>
...
<div className="wrap">
<div style={{ fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '.12em', color: 'rgba(255,255,255,.3)', marginBottom: '12px' }}>📍 Meta Ads — Indore</div>
<h2>Get Daily Leads from Facebook &amp; Instagram in Indore</h2>
<p>Free Meta Ads audit. Full creative strategy included. Launch in 24 hours.</p>
<div className="cta-btns">
<a href="#get-audit" className="btn btn-ac">Get Free Meta Ads Audit →</a>
<a href="https://wa.me/919407000101?text=Hi%2C%20I%20need%20Meta%20Ads%20for%20my%20Indore%20business" target="_blank" rel="noopener" className="btn btn-wa">💬 WhatsApp Now</a>
<a href="tel:+919407000101" className="btn btn-outline-white">📞 +91 94070 00101</a>
</div>
</div>
</section>
      <PageScript id="locations-indore-meta-ads-0" code={js0} />
    </>
  )
}
