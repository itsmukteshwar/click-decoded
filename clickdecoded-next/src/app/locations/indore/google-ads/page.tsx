/* eslint-disable */
// src/app/locations/indore/google-ads/page.tsx — generated from google-ads-indore.html (do not edit header/footer here)
import type { Metadata } from 'next'
import PageScript from '@/components/chrome/PageScript'

export const metadata: Metadata = {
  title: "Google Ads Agency in Indore | PPC Management — Click Decoded",
  description: "Expert Google Ads management for Indore businesses. Search, Display & Shopping campaigns. Maximise ROI, minimise wasted spend. Free PPC audit. Call +91.",
  alternates: { canonical: "/locations/indore/google-ads" },
  openGraph: {
    title: "Google Ads Agency in Indore — Click Decoded",
    description: "ROI-focused Google Ads management for Indore businesses. Free PPC audit.",
    url: "/locations/indore/google-ads",
    type: "website",
  },
}
...
.gai-mock{background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:20px;overflow:hidden;backdrop-filter:blur(10px);}
.gai-hdr{background:rgba(255,255,255,.05);border-bottom:1px solid rgba(255,255,255,.08);padding:14px 18px;display:flex;align-items:center;justify-content:space-between;}
.gai-hdr-title{font-size:12px;font-weight:700;color:rgba(255,255,255,.7);letter-spacing:.04em;}
.gai-live{display:flex;align-items:center;gap:6px;font-size:11px;color:#EF4444;font-weight:600;}
.gai-live::before{content:'';width:7px;height:7px;border-radius:50%;background:#EF4444;box-shadow:0 0 0 3px rgba(239,68,68,.2);animation:gaip 2s infinite;}
@keyframes gaip{0%,100%{box-shadow:0 0 0 3px rgba(239,68,68,.2);}50%{box-shadow:0 0 0 6px rgba(239,68,68,.05);}}
.gai-kpis{display:grid;grid-template-columns:1fr 1fr;gap:1px;background:rgba(255,255,255,.06);}
.gai-kpi{background:#0f1e38;padding:14px 16px;}
.gai-kpi-lbl{font-size:10px;font-weight:600;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.08em;margin-bottom:5px;}
.gai-kpi-val{font-size:20px;font-weight:900;color:#EF4444;letter-spacing:-.02em;line-height:1;}
.gai-kpi-d{font-size:10.5px;margin-top:3px;font-weight:600;color:#4caf50;}
.gai-rows{padding:14px 18px;border-top:1px solid rgba(255,255,255,.06);}
.gai-rows-lbl{font-size:10px;font-weight:600;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px;}
.gai-row{display:flex;justify-content:space-between;align-items:center;padding:5px 0;border-bottom:1px solid rgba(255,255,255,.04);font-size:11.5px;}
.gai-row:last-child{border:none;}
.gai-row-n{color:rgba(255,255,255,.55);}
.gai-row-v{color:#fca5a5;font-weight:700;font-size:11px;}
.gai-btm{padding:12px 18px;background:rgba(239,68,68,.06);border-top:1px solid rgba(239,68,68,.1);display:flex;align-items:center;justify-content:space-between;}
.gai-btm-lbl{font-size:11.5px;color:rgba(255,255,255,.45);}
.gai-btm-val{font-size:15px;font-weight:800;color:#EF4444;}
@media(max-width:900px){.hero-grid{grid-template-columns:1fr;}.gai-mock{display:none;}}
`
  ...
  "@graph": [
    {
      ...
      "description": "Expert Google Ads management for Indore businesses. Search, Display & Shopping campaigns. Maximise ROI, minimise wasted spend. Free PPC audit. Call +91 94070 00101.",
      "areaServed": {
        "@type": "City",
        "name": "Indore"
      },
      "serviceType": "Google Ads Management",
      "url": "https://www.clickdecoded.com/locations/indore/google-ads"
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        },
        {
          ...
          "position": 2,
          "name": "Google Ads Management",
          "item": "https://www.clickdecoded.com/locations/indore/google-ads"
        }
      ]
    }
  ]
...
<li>›</li>
<li>Google Ads Agency in Indore</li>
</ol>
</div>
</nav>
...
<div>
<div className="hero-eyebrow">🎯 Google Ads — Indore, MP</div>
<h1>Google Ads That Get<br /><em>Indore Leads, Not Just Clicks.</em></h1>
<p className="hero-desc">Every rupee on Google Ads should bring back more. We manage Indore PPC campaigns with an obsession for ROI — ruthless elimination of wasted spend, maximum qualified leads.</p>
...
<span className="proof-item"><strong>₹0</strong> Wasted on Junk Clicks</span>
<span className="proof-item"><strong>Indore</strong> Office — We're Local</span>
</div>
</div>
<div className="gai-mock">
<div className="gai-hdr">
<span className="gai-hdr-title">Google Ads Dashboard — Indore</span>
<span className="gai-live">Live</span>
</div>
<div className="gai-kpis">
<div className="gai-kpi"><div className="gai-kpi-lbl">Monthly Leads</div><div className="gai-kpi-val">468</div><div className="gai-kpi-d">↑ 312% vs before</div></div>
<div className="gai-kpi"><div className="gai-kpi-lbl">Avg. CPC</div><div className="gai-kpi-val">₹21</div><div className="gai-kpi-d">↓ 66% from ₹62</div></div>
<div className="gai-kpi"><div className="gai-kpi-lbl">ROAS</div><div className="gai-kpi-val">4.6×</div><div className="gai-kpi-d">↑ from 1.1× at start</div></div>
<div className="gai-kpi"><div className="gai-kpi-lbl">Conv. Rate</div><div className="gai-kpi-val">9.4%</div><div className="gai-kpi-d">↑ from 1.2%</div></div>
</div>
<div className="gai-rows">
<div className="gai-rows-lbl">Top Performing Indore Campaigns</div>
<div className="gai-row"><span className="gai-row-n">Real Estate Search Ads</span><span className="gai-row-v">₹19 CPC · 10.2% CVR</span></div>
<div className="gai-row"><span className="gai-row-n">Hospital — Local Search</span><span className="gai-row-v">₹28 CPC · 8.4% CVR</span></div>
<div className="gai-row"><span className="gai-row-n">Coaching Institute Lead Gen</span><span className="gai-row-v">₹17 CPC · 12.1% CVR</span></div>
</div>
<div className="gai-btm">
<span className="gai-btm-lbl">📈 Total Ad Spend Managed — Indore</span>
<span className="gai-btm-val">₹36L+ this year</span>
</div>
</div>
</div>
</div>
...
<div><div className="res-num">5<em>x</em></div><div className="res-label">Average ROAS</div></div>
<div><div className="res-num">40<em>%</em></div><div className="res-label">Lower CPA vs. Avg</div></div>
<div><div className="res-num">500<em>+</em></div><div className="res-label">Campaigns Managed</div></div>
...
<h2>Complete Google Ads Management for Indore Businesses</h2>
<p>Everything included — no half-measures, no hidden extras.</p>
</div>
<div className="inc-grid">
<div className="inc-card">
<div className="inc-icon">🔍</div>
<div className="inc-title">Search Campaigns</div>
<div className="inc-desc">Capture high-intent Indore buyers the moment they search for your product or service.</div>
<ul className="inc-list"> <li>Keyword research &amp; grouping</li>
<li>Negative keyword management</li>
<li>Ad copy A/B testing</li>
<li>Quality Score optimization</li>
<li>Bid strategy management</li></ul>
</div>
<div className="inc-card">
<div className="inc-icon">🖼️</div>
<div className="inc-title">Display &amp; Remarketing</div>
<div className="inc-desc">Stay top-of-mind for Indore visitors who didn't convert the first time.</div>
<ul className="inc-list"> <li>Audience segmentation</li>
<li>Custom intent audiences</li>
<li>Remarketing lists</li>
<li>Display banner creation</li>
<li>Frequency capping</li></ul>
</div>
<div className="inc-card">
<div className="inc-icon">🛒</div>
<div className="inc-title">Shopping Campaigns</div>
<div className="inc-desc">Perfect for Indore e-commerce — get your products in front of buyers with purchase intent.</div>
<ul className="inc-list"> <li>Product feed optimization</li>
<li>Smart Shopping setup</li>
<li>Performance Max</li>
<li>Product title optimization</li>
<li>ROAS bidding</li></ul>
</div>
<div className="inc-card">
<div className="inc-icon">📊</div>
<div className="inc-title">Conversion Tracking</div>
<div className="inc-desc">If you can't measure it, you can't improve it. We track every lead and sale.</div>
<ul className="inc-list"> <li>Google Tag Manager setup</li>
<li>Goal &amp; event tracking</li>
<li>Phone call tracking</li>
<li>Form submission tracking</li>
<li>GA4 integration</li></ul>
</div>
<div className="inc-card">
<div className="inc-icon">🧪</div>
<div className="inc-title">Landing Page Optimization</div>
<div className="inc-desc">Your ad is only as good as the page it sends people to. We fix the full funnel.</div>
<ul className="inc-list"> <li>Landing page audit</li>
<li>CTA &amp; headline testing</li>
<li>Mobile conversion check</li>
<li>Page speed for ads</li>
<li>Lead form optimization</li></ul>
</div>
<div className="inc-card">
<div className="inc-icon">📋</div>
<div className="inc-title">Monthly PPC Reports</div>
<div className="inc-desc">Transparent reporting — spend, clicks, conversions, cost per lead, and next steps.</div>
<ul className="inc-list"> <li>Spend &amp; ROAS report</li>
<li>Keyword performance</li>
<li>Ad copy results</li>
<li>Search term analysis</li>
<li>Next-month strategy</li></ul>
</div>
</div>
</div>
</section>
...
<div className="pt-content"><div className="pt-title">Account Audit</div><div className="pt-desc">We audit your existing Google Ads account (or assess your market opportunity if starting fresh).</div></div>
</div>
<div className="pt-item">
<div className="pt-num">02</div>
<div className="pt-content"><div className="pt-title">Strategy &amp; Structure</div><div className="pt-desc">We build a campaign structure, keyword plan, and bidding strategy around your Indore business goals.</div></div>
</div>
<div className="pt-item">
<div className="pt-num">03</div>
<div className="pt-content"><div className="pt-title">Campaign Launch</div><div className="pt-desc">We write ad copy, set up tracking, build audiences, and launch — typically within 48 hours.</div></div>
</div>
<div className="pt-item">
<div className="pt-num">04</div>
<div className="pt-content"><div className="pt-title">Optimization Cycle</div><div className="pt-desc">Weekly optimization — pausing wasteful keywords, scaling winners, testing new ad copy.</div></div>
</div>
<div className="pt-item">
<div className="pt-num">05</div>
<div className="pt-content"><div className="pt-title">Monthly Reports</div><div className="pt-desc">Full transparency: spend, leads, cost per lead, ROAS, and next month's plan.</div></div>
</div>
</div>
</div>
</section>
...
<div className="wrap">
<div className="sec-h">
<div className="eyebrow">❓ FAQs — Google Ads Management Indore</div>
<h2>Common Questions</h2>
</div>
<div className="faq-list">
<div className="faq-item">
<button className="faq-q">How much should I spend on Google Ads in Indore? <span className="faq-chevron">+</span></button>
<div className="faq-a"><div className="faq-a-inner">Budget depends on your industry and goals. Our minimum management engagement is ₹25,000/month (management fee). Ad spend is separate and we recommend starting with at least ₹15,000–₹30,000/month for meaningful Indore traffic.</div></div>
</div>
<div className="faq-item">
<button className="faq-q">How quickly will I see results from Google Ads in Indore? <span className="faq-chevron">+</span></button>
<div className="faq-a"><div className="faq-a-inner">Google Ads starts driving traffic within 24–48 hours of launch. Lead quality and volume improves over 2–4 weeks as we optimize based on real data.</div></div>
</div>
<div className="faq-item">
<button className="faq-q">Do you manage both Search and Shopping campaigns for Indore businesses? <span className="faq-chevron">+</span></button>
<div className="faq-a"><div className="faq-a-inner">Yes. We manage Search, Display, Shopping, Remarketing, and Performance Max campaigns depending on your business type and goals.</div></div>
</div>
<div className="faq-item">
<button className="faq-q">What is a good ROAS for Google Ads in Indore? <span className="faq-chevron">+</span></button>
<div className="faq-a"><div className="faq-a-inner">For most Indore service businesses, a ROAS of 3–5x is achievable with well-managed campaigns. E-commerce can reach 5–10x with optimized Shopping campaigns.</div></div>
</div>
<div className="faq-item">
<button className="faq-q">Do you work with existing Google Ads accounts in Indore? <span className="faq-chevron">+</span></button>
<div className="faq-a"><div className="faq-a-inner">Yes. We do a full audit of your existing account first, identify waste and opportunity, then take over management.</div></div>
</div>
<div className="faq-item">
<button className="faq-q">Will my Indore competitor see my ads? <span className="faq-chevron">+</span></button>
<div className="faq-a"><div className="faq-a-inner">Yes — your ads show to anyone searching relevant keywords in your target area, including competitors. But they're paying per click, so this rarely matters.</div></div>
</div>
</div>
</div>
</section>
...
<a href="/locations/indore/social-media-marketing" className="rel-pill">📱 Social Media Indore</a>
...
<div className="wrap">
<div style={{ fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '.12em', color: 'rgba(255,255,255,.3)', marginBottom: '12px' }}>📍 Google Ads — Indore</div>
<h2>Start Getting Indore Leads from Google Ads</h2>
<p>Free PPC audit. Campaign strategy included. First results within 48 hours.</p>
<div className="cta-btns">
<a href="#get-audit" className="btn btn-ac">Get Free PPC Audit →</a>
<a href="https://wa.me/919407000101?text=Hi%2C%20I%20need%20Google%20Ads%20management%20for%20my%20Indore%20business" target="_blank" rel="noopener" className="btn btn-wa">💬 WhatsApp Now</a>
<a href="tel:+919407000101" className="btn btn-outline-white">📞 +91 94070 00101</a>
</div>
</div>
</section>
      <PageScript id="locations-indore-google-ads-0" code={js0} />
    </>
  )
}
