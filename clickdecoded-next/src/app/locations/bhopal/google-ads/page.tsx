/* eslint-disable */
// src/app/locations/bhopal/google-ads/page.tsx — generated from google-ads-bhopal.html (do not edit header/footer here)
import type { Metadata } from 'next'
import PageScript from '@/components/chrome/PageScript'

export const metadata: Metadata = {
  title: "Google Ads Management in Bhopal | PPC Agency — Click Decoded",
  description: "Expert Google Ads management for Bhopal businesses. Search, Display & Shopping campaigns that drive real leads. Free account audit. Call +91 94070 00101.",
  alternates: { canonical: "/locations/bhopal/google-ads" },
  openGraph: {
    title: "Google Ads Bhopal — PPC That Drives Real Leads | Click Decoded",
    url: "/locations/bhopal/google-ads",
    type: "website",
  },
}

const css = `
:root{--n:#2A4573;--n2:#1e3460;--n-dark:#0f1e38;--o:#EE7E1A;--o2:#d46e12;--body:#1E293B;--m:#475569;--s:#64748b;--bg:#F4F7FC;--bdr:#E2E8F0;--gr:#25D366;--ac:#EF4444;--ac-rgb:239,68,68;}
...
.hero{background:linear-gradient(155deg,#1a0505 0%,#2d0a0a 55%,#1a0505 100%);}
.results-strip{background:linear-gradient(135deg,#1a0505,#2d0a0a);}
.cta-strip{background:linear-gradient(135deg,#1a0505,#2d0a0a);}
...
.hero::before{content:'';position:absolute;inset:0;background:radial-gradient(ellipse 55% 60% at 70% 30%,rgba(239,68,68,.18) 0%,transparent 65%),radial-gradient(ellipse 35% 40% at 5% 80%,rgba(239,68,68,.07) 0%,transparent 60%);pointer-events:none;}
.hero-grid{display:grid;grid-template-columns:1fr 1fr;gap:60px;align-items:center;position:relative;z-index:2;}
.hero-eyebrow{display:inline-flex;align-items:center;gap:8px;padding:6px 16px;background:rgba(239,68,68,.12);border:1px solid rgba(239,68,68,.3);border-radius:99px;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.12em;color:#fca5a5;margin-bottom:20px;}
...
.hero h1 em{font-style:normal;background:linear-gradient(135deg,#fca5a5,#EF4444);-webkit-background-clip:text;-webkit-text-fill-color:transparent;background-clip:text;}
.hero-desc{font-size:17px;color:rgba(255,255,255,.62);line-height:1.7;margin-bottom:32px;max-width:460px;}
.hero-btns{display:flex;gap:12px;flex-wrap:wrap;margin-bottom:36px;}
.gab-mock{background:rgba(255,255,255,.04);border:1px solid rgba(255,255,255,.1);border-radius:20px;overflow:hidden;backdrop-filter:blur(10px);}
.gab-hdr{background:rgba(255,255,255,.05);border-bottom:1px solid rgba(255,255,255,.08);padding:14px 18px;display:flex;align-items:center;justify-content:space-between;}
.gab-hdr-title{font-size:12px;font-weight:700;color:rgba(255,255,255,.7);letter-spacing:.04em;}
.gab-live{display:flex;align-items:center;gap:6px;font-size:11px;color:#EF4444;font-weight:600;}
.gab-live::before{content:'';width:7px;height:7px;border-radius:50%;background:#EF4444;box-shadow:0 0 0 3px rgba(239,68,68,.2);animation:gabp 2s infinite;}
@keyframes gabp{0%,100%{box-shadow:0 0 0 3px rgba(239,68,68,.2);}50%{box-shadow:0 0 0 6px rgba(239,68,68,.05);}}
.gab-kpis{display:grid;grid-template-columns:1fr 1fr;gap:1px;background:rgba(255,255,255,.06);}
.gab-kpi{background:#0f1e38;padding:14px 16px;}
.gab-kpi-lbl{font-size:10px;font-weight:600;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.08em;margin-bottom:5px;}
.gab-kpi-val{font-size:20px;font-weight:900;color:#EF4444;letter-spacing:-.02em;line-height:1;}
.gab-kpi-d{font-size:10.5px;margin-top:3px;font-weight:600;color:#4caf50;}
.gab-rows{padding:14px 18px;border-top:1px solid rgba(255,255,255,.06);}
.gab-rows-lbl{font-size:10px;font-weight:600;color:rgba(255,255,255,.35);text-transform:uppercase;letter-spacing:.08em;margin-bottom:8px;}
.gab-row{display:flex;justify-content:space-between;align-items:center;padding:5px 0;border-bottom:1px solid rgba(255,255,255,.04);font-size:11.5px;}
.gab-row:last-child{border:none;}
.gab-row-n{color:rgba(255,255,255,.55);}
.gab-row-v{color:#fca5a5;font-weight:700;font-size:11px;}
.gab-btm{padding:12px 18px;background:rgba(239,68,68,.06);border-top:1px solid rgba(239,68,68,.1);display:flex;align-items:center;justify-content:space-between;}
.gab-btm-lbl{font-size:11.5px;color:rgba(255,255,255,.45);}
.gab-btm-val{font-size:15px;font-weight:800;color:#EF4444;}
@media(max-width:900px){.hero-grid{grid-template-columns:1fr;}.gab-mock{display:none;}}
`
  ...
  "@graph": [
    {
      ...
      "url": "https://www.clickdecoded.com/locations/bhopal/google-ads"
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        ...
        },
        {
          ...
          "item": "https://www.clickdecoded.com/locations/bhopal/google-ads"
        }
      ]
    }
  ]
...
export default function Page() {
  return (
    <>
      ...
      <nav className="breadcrumb"><div className="wrap"><ol className="bc-list"><li><a href="/">Home</a></li><li>›</li><li><a href="/service-areas">Areas We Work</a></li><li>›</li><li><a href="/locations/bhopal/digital-marketing">Bhopal</a></li><li>›</li><li>🎯 Bhopal's Google Ads Specialists</li></ol></div></nav>
      <section className="hero">
<div className="wrap">
<div className="hero-grid">
<div>
<div className="hero-eyebrow">🎯 Google Ads — Bhopal, MP</div>
<h1>Get Bhopal Customers<br /><em>From Day One.</em></h1>
<p className="hero-desc">We run high-ROI Google Ads campaigns for Bhopal businesses — Search, Display, and Shopping ads that bring qualified leads, not clicks that burn your budget.</p>
<div className="hero-btns">
<a href="/contact" className="btn btn-ac">🎯 Get Free Ads Audit</a>
...
<span className="proof-item"><strong>Bhopal</strong> Office Walk-ins Welcome</span>
</div>
</div>
<div className="gab-mock">
<div className="gab-hdr">
<span className="gab-hdr-title">Google Ads Dashboard — Bhopal</span>
<span className="gab-live">Live</span>
</div>
<div className="gab-kpis">
<div className="gab-kpi"><div className="gab-kpi-lbl">Monthly Leads</div><div className="gab-kpi-val">312</div><div className="gab-kpi-d">↑ 286% vs before</div></div>
<div className="gab-kpi"><div className="gab-kpi-lbl">Avg. CPC</div><div className="gab-kpi-val">₹24</div><div className="gab-kpi-d">↓ 61% from ₹62</div></div>
<div className="gab-kpi"><div className="gab-kpi-lbl">ROAS</div><div className="gab-kpi-val">4.1×</div><div className="gab-kpi-d">↑ from 1.2× at start</div></div>
<div className="gab-kpi"><div className="gab-kpi-lbl">Conv. Rate</div><div className="gab-kpi-val">8.2%</div><div className="gab-kpi-d">↑ from 1.4%</div></div>
</div>
<div className="gab-rows">
<div className="gab-rows-lbl">Top Performing Campaigns</div>
<div className="gab-row"><span className="gab-row-n">Real Estate Search Ads</span><span className="gab-row-v">₹18 CPC · 9.4% CVR</span></div>
<div className="gab-row"><span className="gab-row-n">Hospital — Local Search</span><span className="gab-row-v">₹31 CPC · 7.8% CVR</span></div>
<div className="gab-row"><span className="gab-row-n">Education Lead Gen</span><span className="gab-row-v">₹22 CPC · 11.2% CVR</span></div>
</div>
<div className="gab-btm">
<span className="gab-btm-lbl">📈 Total Ad Spend Managed</span>
<span className="gab-btm-val">₹28L+ this year</span>
</div>
</div>
</div>
</div>
</section>
      <div className="results-strip"><div className="wrap"><div className="results-inner"><div><div className="res-num">3<em>x</em></div><div className="res-label">Average ROAS</div><div className="res-sub">for Bhopal clients</div></div><div><div className="res-num">30<em>%</em></div><div className="res-label">Lower CPA</div><div className="res-sub">vs. self-managed campaigns</div></div><div><div className="res-num">500<em>+</em></div><div className="res-label">Campaigns Managed</div><div className="res-sub">since 2014</div></div><div><div className="res-num">12<em>yr</em></div><div className="res-label">Google Ads Experience</div><div className="res-sub">Bhopal-based</div></div></div></div></div>
...
<div className="inc-grid"><div className="inc-card"><div className="inc-icon">🔍</div><div className="inc-title">Search Campaigns</div><div className="inc-desc">Show your ads when Bhopal customers search for exactly what you offer — maximum purchase intent.</div><ul className="inc-list"><li>Keyword research &amp; match types</li><li>Negative keyword management</li><li>Ad copy A/B testing</li><li>Quality Score optimization</li><li>Conversion tracking setup</li></ul></div><div className="inc-card"><div className="inc-icon">🛍️</div><div className="inc-title">Shopping Ads</div><div className="inc-desc">For e-commerce — get your products in front of Bhopal buyers at the exact moment they're ready to purchase.</div><ul className="inc-list"><li>Google Merchant Center setup</li><li>Product feed optimization</li><li>Smart Shopping campaigns</li><li>ROAS-focused bidding</li><li>Competitor product analysis</li></ul></div><div className="inc-card"><div className="inc-icon">🖥️</div><div className="inc-title">Display &amp; Remarketing</div><div className="inc-desc">Re-engage Bhopal visitors who didn't convert the first time, and build brand awareness across Google's network.</div><ul className="inc-list"><li>Remarketing audience setup</li><li>Custom audience targeting</li><li>Banner creative guidelines</li><li>Frequency capping</li><li>Competitor audience targeting</li></ul></div><div className="inc-card"><div className="inc-icon">📊</div><div className="inc-title">Bid Strategy &amp; Budget</div><div className="inc-desc">We manage your bids and budget to squeeze maximum ROI — no money wasted on underperforming keywords.</div><ul className="inc-list"><li>Smart bidding (Target CPA/ROAS)</li><li>Dayparting optimization</li><li>Device bid adjustments</li><li>Location bid adjustments</li><li>Budget pacing control</li></ul></div><div className="inc-card"><div className="inc-icon">📄</div><div className="inc-title">Landing Page Advice</div><div className="inc-desc">Clicks mean nothing if the landing page doesn't convert. We audit and advise on your landing page performance.</div><ul className="inc-list"><li>Above-fold CTA audit</li><li>Form optimization advice</li><li>Page speed recommendations</li><li>Trust signal placement</li><li>Mobile UX review</li></ul></div><div className="inc-card"><div className="inc-icon">📈</div><div className="inc-title">Monthly Reporting</div><div className="inc-desc">Clear reports showing spend, clicks, conversions, CPA, and ROAS — in plain language your team understands.</div><ul className="inc-list"><li>Monthly performance report</li><li>Keyword-level data</li><li>Conversion attribution</li><li>Competitor auction insights</li><li>Next-month strategy</li></ul></div></div>
</div>
</section>
...
<div className="process-timeline"><div className="pt-item"><div className="pt-num">01</div><div className="pt-content"><div className="pt-title">Account Audit / Setup</div><div className="pt-desc">We audit your existing Google Ads account for wasted spend, poor Quality Scores, and missing conversions. For new clients, we build the account from scratch with proper structure.</div></div></div><div className="pt-item"><div className="pt-num">02</div><div className="pt-content"><div className="pt-title">Keyword &amp; Competitor Research</div><div className="pt-desc">We research every search term your Bhopal customers use, identify competitor ad strategies, and build a keyword plan that targets maximum-intent searches while eliminating irrelevant traffic.</div></div></div><div className="pt-item"><div className="pt-num">03</div><div className="pt-content"><div className="pt-title">Campaign Build &amp; Ad Copy</div><div className="pt-desc">We structure your campaigns correctly (Search, Display, Remarketing), write compelling ad copy with strong CTAs, and set up conversion tracking so every lead is attributed accurately.</div></div></div><div className="pt-item"><div className="pt-num">04</div><div className="pt-content"><div className="pt-title">Launch &amp; First 2-Week Optimisation</div><div className="pt-desc">Post-launch, we monitor closely — pausing poor performers, scaling winners, adjusting bids, and expanding negative keyword lists. The first 2 weeks are critical for performance signals.</div></div></div><div className="pt-item" style={{ paddingBottom: '0' }}><div className="pt-num">05</div><div className="pt-content"><div className="pt-title">Monthly Reporting &amp; Scaling</div><div className="pt-desc">Every month: a full report on spend, conversions, CPA, and ROAS. We scale budgets to campaigns and ad groups that demonstrate strong ROI and continuously test new ad copy and audiences.</div></div></div></div>
</div>
</section>
      <section className="faq-section">
<div className="wrap">
<div className="sec-h"><div className="eyebrow">❓ FAQs</div><h2>Common Questions</h2></div>
<div className="faq-list"><div className="faq-item"><button className="faq-q">How much should I spend on Google Ads in Bhopal? <span className="faq-chevron">+</span></button><div className="faq-a"><div className="faq-a-inner">For most Bhopal businesses, a starting budget of ₹15,000–₹30,000/month delivers enough data to optimise effectively. Our management fee starts at ₹25,000/month (separate from ad spend). We help you determine the right budget based on your industry's average CPC and conversion goals.</div></div></div><div className="faq-item"><button className="faq-q">How quickly do Google Ads show results? <span className="faq-chevron">+</span></button><div className="faq-a"><div className="faq-a-inner">Unlike SEO, Google Ads can drive leads from day one. Most Bhopal clients see their first enquiries within 24–48 hours of campaign launch. Optimisation and ROI improvement happen over the first 4–6 weeks as the algorithm gathers data.</div></div></div><div className="faq-item"><button className="faq-q">Do you handle the creative design for Display ads? <span className="faq-chevron">+</span></button><div className="faq-a"><div className="faq-a-inner">We provide guidelines and copy direction for Display ads. For banner design, we work with your existing designer or can recommend one. Search ads (text-based) we handle entirely — copy, testing, and optimisation.</div></div></div><div className="faq-item"><button className="faq-q">What's a good ROAS for Bhopal businesses? <span className="faq-chevron">+</span></button><div className="faq-a"><div className="faq-a-inner">ROAS (Return on Ad Spend) depends heavily on your industry and margins. E-commerce typically targets 3–5x ROAS; lead-gen service businesses measure cost-per-lead instead. We set clear KPIs based on your specific business model before any campaign launches.</div></div></div><div className="faq-item"><button className="faq-q">Will you manage an existing Google Ads account? <span className="faq-chevron">+</span></button><div className="faq-a"><div className="faq-a-inner">Yes — we take over and audit existing accounts regularly. In most cases we find significant budget waste (irrelevant keywords, poor match types, missing negatives) that we eliminate in the first month, often improving results without increasing spend.</div></div></div><div className="faq-item"><button className="faq-q">Do you offer Google Ads + SEO together? <span className="faq-chevron">+</span></button><div className="faq-a"><div className="faq-a-inner">Yes. Many Bhopal clients run Google Ads for immediate leads while SEO builds long-term organic traffic. We manage both, using Ads data to inform SEO keyword strategy and vice versa — a powerful combined approach.</div></div></div></div>
</div>
</section>
...
<div className="wrap">
<div style={{ fontSize: '11px', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '.12em', color: 'rgba(255,255,255,.3)', marginBottom: '12px' }}>🎯 Bhopal's Google Ads Specialists</div>
<h2>Ready to Get Leads from Google Tomorrow?</h2>
<p>Free account audit. Transparent pricing. No lock-in contracts.</p>
...
<a href="tel:+919407000101" className="btn btn-outline-white">📞 +91 94070 00101</a>
      ...
      <PageScript id="locations-bhopal-google-ads-0" code={js0} />
    </>
  )
}
