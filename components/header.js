/* components/header.js — Click Decoded shared nav v4
   Services mega menu: 6 columns (SEO | Paid Ads | AI & Auto | Content | Web & Design | GEO/AI)
   Separate: Industries | White Label | Company
*/
(function(){
  const CAR = `<svg class="dcar" viewBox="0 0 10 10" fill="none"><path d="M2 3.5l3 3 3-3" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></svg>`;
...
<div class="mnav" id="mnav">
  ...
  <div class="ma"><button>Industries <span>+</span></button>
    <div class="ms">
  ...
  <div class="ma"><button>Company <span>+</span></button>
    <div class="ms">
...
`;
  ...
  // Global nav CSS overrides
  const mobileStyle = document.createElement('style');
  mobileStyle.textContent = `
    /* 6-column Services mega */
